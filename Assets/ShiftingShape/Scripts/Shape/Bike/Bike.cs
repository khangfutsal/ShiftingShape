...
{
    public class Bike : BaseShape
    {
        private Rigidbody rigidbody;
        [SerializeField] private Vector3 vMove;


        public float minX; // Ngưỡng giới hạn trục X
        public float maxX; // Ngưỡng giới hạn trục X
        ...
        public void Move()
        {
            if (isTouchingLayerMask)
                ...
                vMove = new Vector3(rigidbody.velocity.x, rigidbody.velocity.y, shapeSO.shapeData.speedUnexpected * Time.deltaTime);
